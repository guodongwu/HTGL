...
namespace HTGL.Component.Tools
{
    /// <summary>
    /// MD5加密帮助类
    /// </summary>
    ...
    public class DEncrypt
    {
        ...
        private const string decode = "MATICSOFT";
        /// <summary>
        /// 构造方法
        /// </summary>
        public DEncrypt()
        ...
        {
            return Encrypt(original, decode);
        }
        /// <summary>
        /// 使用缺省密钥字符串解密string
        /// </summary>
        ...
        {
            return Decrypt(original,decode, System.Text.Encoding.Default);
        }
        ...
        {
            byte[] key = System.Text.Encoding.Default.GetBytes(decode);
