...
namespace Management.Web
{
    public class CurrentUserHelper
    {
        ...
        public static void SaveUserInfo(User user)
        {
            ...
            if (user != null)
            {
                SessionHelper.SetSession("UserID", user.UID);
                //读取角色信息
                UserService service = new UserService();
                string UserRoles = service.GetUserAllRole(user.UID);
        ...
        public CurrentUserHelper(bool IsLoadUserInfo)
        {
        ...
        public User GetCurrentUserInfo()
        {
            ...
            return userService.GetUserInfoByUID(UserID);
        }
        /// <summary>
        /// 获取当前用户的昵称信息
        /// </summary>
